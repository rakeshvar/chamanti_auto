...
from deformer_basic import Deformer, default_config
...
def main():
    ...
    # Run tests
    print(f"\nTesting...")
    print(f"Deformer parameters: {default_config}")
    print("-" * 60)

    # Create test model
    input_shape = (args.height, scriber.width, 1)
    test_model = create_test_model(input_shape, default_config)
    ...
    save_path = output_dir / f"test.png"
